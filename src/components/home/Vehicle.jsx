...
const VehicleScroll = () => {
    ...
    return (
        <section className="py-3 md:py-6 px-3 md:px-8 relative max-w-7xl mx-auto">
            <div className="flex flex-row justify-between items-center mb-3 md:mb-3 px-1">
                    ...
                    <div className="flex-1 min-w-0">
                        <div className="flex flex-col xs:flex-row xs:items-center xs:gap-3">
                            ...
                            {/* <p className="text-gray-600 text-sm md:text-lg flex items-center gap-1 md:gap-2 mt-1 xs:mt-0">
                                ...
                                <span className="truncate">Select your vehicle to browse parts</span>
                            </p> */}
                        </div>
                    </div>
                </div>
                ...
                <div className="mx-1 md:mx-4">
                    <div
                        ...
                        className="flex space-x-4 md:space-x-8 overflow-x-auto scroll-smooth 
                         ...
                         px-2 md:px-6 py-2 md:py-6 -mx-3 md:-mx-6"
                        ...
                        {vehicleList.map(([id, make, model, year, variant, imageURL], index) => {
                            ...
                            return (
                                <div
                                    ...
                                    className="flex-none w-44 md:w-80 bg-white rounded-2xl md:rounded-3xl shadow-md 
                                ...
                                >
                                    <div className="relative overflow-hidden rounded-t-2xl md:rounded-t-3xl bg-gradient-to-br from-gray-50 to-gray-100 flex-shrink-0">
                                        <img
                                            ...
                                            alt={`${make} ${model}`}
                                            className="w-full h-24 md:h-56 object-cover group-hover:scale-105 md:group-hover:scale-110 transition-transform duration-600 ease-out"
                                        />
                                    ...
                                    <div className="p-2 md:p-4 space-y-1 md:space-y-4 flex-1 flex flex-col">
                                        <div className="flex-1">
                                            <h3 className="font-bold text-gray-900 text-sm md:text-lg mb-1 md:mb-2 line-clamp-1 group-hover:text-blue-700 transition-colors">
                                                {make} {model}
                                            </h3>
                                        ...
                                        <button className="w-full bg-gradient-to-r from-gray-100 to-gray-50 
                                                        ...
                                                        hover:text-blue-700 py-1.5 md:py-2 rounded-xl md:rounded-2xl 
